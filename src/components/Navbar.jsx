    ...
    <div>
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-center">
          ...
          <div className="micro-btn btn btn-circle ml-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <div className="dropdown dropdown-end">
            <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
              <div className="w-10 rounded-full">
                <img src="https://preview.redd.it/8sqzvsj05l491.jpg?width=640&crop=smart&auto=webp&s=9b5872bf876ac92cb03f5b632d762e029333fdff" alt="profile"/>
              </div>
            </label>
            <ul
              tabIndex={0}
