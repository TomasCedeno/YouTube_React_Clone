...
function Video({ video }) {
  return (
    <div>
      <div className="col-span-12 sm:col-span-6 md:col-span-3 mb-10">
        <div className="w-full flex flex-col">
          <div className="relative">
            ...
            <p className="absolute rounded-md right-2 bottom-2 bg-gray-900 text-gray-100 text-xs px-1 py">
              {video.duration}
            </p>
          </div>
          ...
          <div className="flex flex-row mt-2 gap-2">
            <a href="/#">
              <img
                src="https://yt3.googleusercontent.com/ytc/AOPolaTyPJ1RwXvyvmaQh3pR4ihjRXRNcMdzmd8mXtvZRQ=s900-c-k-c0x00ffffff-no-rj"
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-500 text-xs mt-1">{video.info}</p>
            </div>
          </div>
        </div>
      </div>
